...
class EMailer
{
   ...
   protected $pathLayouts = 'application.views.email.layouts';
    ...
    /**
    * BEGIN PROPERTIES ADDED BY ON
    * Sets the From email address for the message. Set in config file
    * @var string
    */
    public $from;
    ...
    /**
    *  END PROPERTIES ADDED BY ON
    * Sets the From name for the message. Set in config file
    * @var string
    */
    public $fromName;
   ...
   public function init() {
   	//Added by ON
   		$this->_myMailer->Mailer = Yii::app()->params['emailProgram'];
   		$this->_myMailer->From = $this->from;
        $this->_myMailer->FromName = $this->fromName;
   //End Adde by ON
   }
