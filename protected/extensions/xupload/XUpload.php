...
class XUpload extends CJuiInputWidget {
    ...
    public function publishAssets() {
        ...
        if (is_dir($assets)) {
            ...
            Yii::app() -> clientScript -> registerScriptFile("/js/xupload/tmpl.min.js", CClientScript::POS_END);
            ...
            if($this->previewImages || $this->imageProcessing){
                Yii::app() -> clientScript -> registerScriptFile("/js/xupload/load-image.min.js", CClientScript::POS_END);
                Yii::app() -> clientScript -> registerScriptFile("/js/xupload/canvas-to-blob.min.js", CClientScript::POS_END);
            }
